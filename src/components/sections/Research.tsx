      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white tracking-tighter mb-6">
                SCIENTIFIC PROGRESS & <span className="text-purple-400">DEVELOPMENT</span>
              </h2>
            ...
            <div
              className="bg-purple-500/5 border border-purple-500/10 rounded-[40px] p-8 md:p-12 text-center"
            >
              <h3 className="text-2xl font-bold text-white mb-8">Achievements</h3>
              <div className="space-y-6">
                {achievements.map((ach, i) => (
                  <div key={i} className="flex items-center gap-4 group justify-center">
                    <div className="w-10 h-10 rounded-xl bg-purple-500/10 flex items-center justify-center group-hover:bg-purple-500/20 transition-colors">
                      <ach.icon className="text-purple-400" size={20} />
                    </div>
